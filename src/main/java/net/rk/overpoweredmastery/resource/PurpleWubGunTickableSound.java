...
public class PurpleWubGunTickableSound extends AbstractTickableSoundInstance{
    ...
    public void tick() {
        count++;
        if(this.player.getItemInHand(player.getUsedItemHand()).is(OMItems.PURPLE_WUBS)){
