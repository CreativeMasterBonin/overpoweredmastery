...
public class ChickenWubs extends AbstractWubs{
    public ChickenWubs(Properties p) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.accept(Component.translatable("item.overpoweredmastery.chicken_wubs.desc")
                .withColor(16711776));
    }
        ...
        if(livingEntity instanceof Player){
            ...
            if(level instanceof ServerLevel serverLevel){
                if(remainingUseDuration % 7 == 0 && remainingUseDuration < 994 && !((Player) livingEntity).isSecondaryUseActive()){
                    ChickenWubEnergyBall fireball = new ChickenWubEnergyBall(livingEntity,livingEntity.getViewVector(remainingUseDuration),level);
